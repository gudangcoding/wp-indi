...
<!--	<table cellspacing="0" class="shop_table shop_table_responsive">
    ...
    <div class="order_box">
        <div class="part1">
            ...
            <div class="right">
                <p data-title="<?php _e('Subtotal', 'woocommerce'); ?>"><?php wc_cart_totals_subtotal_html(); ?></p>
            </div>
        ...
        <?php foreach (WC()->cart->get_coupons() as $code => $coupon) : ?>
            ...
            <div class="part2 cart-discount coupon-<?php echo esc_attr(sanitize_title($code)); ?>">
                <div class="left">
        ...
        <?php elseif (WC()->cart->needs_shipping()) : ?>
            ...
            <div class="part2">
                ...
                <div class="right">
                    <p data-title="<?php _e('Shipping', 'woocommerce'); ?>"><?php woocommerce_shipping_calculator(); ?></p>
                </div>
                <div class="clearfix"></div>
            </div>
        ...
        <div class="part3 order-total">
            <div class="left">
                <p><?php _e('Total', 'woocommerce'); ?></p>
            </div>
            <div class="right">
                <p data-title="<?php _e('Total', 'woocommerce'); ?>"><?php wc_cart_totals_order_total_html(); ?></p>
            </div>
            <div class="clearfix"></div>
        </div>
