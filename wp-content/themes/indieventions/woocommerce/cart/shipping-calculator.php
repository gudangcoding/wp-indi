...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<p><a href="javascript:void(0)" class="shipping-calculator-button"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></a></p>
	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<?php endif; ?>
                        ...
                        <p><button type="submit" name="calc_shipping" value="1" class="btn btn-primary" id="modal" data-modal="modal"><?php _e( 'GET A QUOTE', 'woocommerce' ); ?></button></p>
