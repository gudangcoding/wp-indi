...
<!--                                <li class="disabled"><a data-toggle="tab" href="#delivery"><i class="fa fa-truck"></i><br>Delivery Method</a></li>-->
 ...
 <!-----------------different address----------------------->
   <h3 id="ship-to-different-address" >
			...
			<input id="ship-to-different-address-checkbox" class="input-checkbox skip_add" <?php checked( $ship_to_different_address, 1 ); ?> type="checkbox" name="ship_to_different_address" value="1" />
		</h3>
 <div class="woocommerce-shipping-fields" id="diff_ship" style="display:none;">
