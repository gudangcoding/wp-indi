...
<p class="myaccount_address" style="border-bottom: 2px solid #999;padding-bottom: 5px;">
...
<div class="col-lg-6 col-sm-6 border_right">
    <div class="col-<?php echo ( ( $col = $col * -1 ) < 0 ) ? 1 : 2; ?> address" >
		<header class="title">
			<h3><?php echo $title; ?></h3>
			<a href="<?php echo wc_get_endpoint_url( 'edit-address', $name ); ?>" class="btn btn-default edit"><?php _e( 'Edit', 'woocommerce' ); ?></a>
		</header>
		<address>
			<?php
