...
class WC_Product {
	...
	public function get_rating_html( $rating = null ) {
		...
		if ( ! is_numeric( $rating ) ) {
			$rating = round($this->get_average_rating());
		}
...
//
//			$rating_html .= '<span style="width:' . ( ( $rating / 5 ) * 100 ) . '%"><strong class="rating"><img src="http://eshopper.local/wp-content/themes/eshopper/images/star_'.$rating.'.png" alt="star" class="img-responsive"></strong> ' . __( 'out of 5', 'woocommerce' ) . '</span>';
//
//			$rating_html .= '</div>';
//                        
                     $rating_html = $rating ;
