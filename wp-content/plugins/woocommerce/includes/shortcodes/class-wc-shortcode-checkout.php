        ...
        if (isset($_GET['pay_for_order']) && isset($_GET['key']) && $order_id) {
            ...
            if ($order->id == $order_id && $order->order_key == $order_key) {
                ...
                if ($order->needs_payment()) {
                    ...
                    <div class="container">
                        <ul class="order_details" style="float: none;height: auto;margin: 0 auto;text-align: center;width: 100%;
                            border-radious:3px;
                            background-color:#f9f9f9;
                            -webkit-box-shadow: -1px 11px 13px -8px rgba(0,0,0,0.75);
                            -moz-box-shadow: -1px 11px 13px -8px rgba(0,0,0,0.75);
                            box-shadow: -1px 11px 13px -8px rgba(0,0,0,0.75);">
                            ...
                            <li class="date" style="border-bottom: 1px solid #dcdcdc;
                                line-height: 30px;
                                padding: 17px 0;">
                                <?php _e('Date:', 'woocommerce'); ?>
                                <strong><?php echo date_i18n(get_option('date_format'), strtotime($order->order_date)); ?></strong>
                            </li>
                            <li class="total" style="border-bottom: 1px solid #dcdcdc;
                                line-height: 30px;
                                padding: 17px 0;">
                            ...
                            <?php if ($order->payment_method_title) : ?>
                                <li class="method" style="border-bottom: 1px solid #dcdcdc;
                                    line-height: 30px;
                                    padding: 17px 0;">
