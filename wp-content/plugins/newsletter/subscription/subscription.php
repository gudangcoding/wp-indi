...
//                return $user;
    ...
    function get_subscription_form($referrer = null, $action = null, $attrs = array()) {
        ...
        $buffer .= "<!-- email -->\n";
        $buffer .= "<tr>\n\t" . '<th>' . $options_profile['email1'] . '</th>' . "\n\t" . '<td align="left"><input class="newsletter-email form-control s_2" type="email" placeholder="Enter your email id" name="ne" size="30" required></td>' . "\n" . '</tr>' . "\n\n";
        ...
        if (strpos($options_profile['subscribe'], 'http://') !== false) {
            ...
            $buffer .= "\t\t" . '<input class="newsletter-submit btn btn-primary s_3" type="submit" value="' . $options_profile['subscribe'] . '"/>' . "\n\t</td>\n</tr>\n\n";
        }
