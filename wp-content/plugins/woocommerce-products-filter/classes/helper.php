        ...
        $price_slider_html = '<form method="get" action="' . esc_url($form_action) . '">
			<div class="price_slider_wrapper">
				...
				<div class="price_slider_amount">
                                 <div class="col-sm-6 p_less">
					<input type="text" id="min_price" class="form-control l_2" name="min_price" value="' . esc_attr($min_price) . '" data-min="' . esc_attr(apply_filters('woocommerce_price_filter_widget_amount', $min)) . '" placeholder="' . __('Min price', 'woocommerce-products-filter') . '" />
                                            </div>
                                            <div class="col-sm-6 p_less">
					<input type="text" id="max_price" class="form-control l_2" name="max_price" value="' . esc_attr($max_price) . '" data-max="' . esc_attr(apply_filters('woocommerce_price_filter_widget_amount', $max)) . '" placeholder="' . __('Max price', 'woocommerce-products-filter') . '" />
                                            </div>
                                             <div class="col-sm-12 p_less">
					<button type="submit" class="button btn btn-primary up_1">' . __('Filter', 'woocommerce-products-filter') . '</button>
                                            </div>
