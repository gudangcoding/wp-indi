	...
	<?php if ( WC_Vendors::$pv_options->get_option( 'show_vendor_registration' ) ) { ?>
		...
		<form method="POST" action="">
			<div class="clear"></div>
                        ...
                        <div class="fom_line_a">
                            <p class="form-row">
                            <div class="left_fom">
                        <input class="input-checkbox ven pull-right"
					   id="apply_for_vendor" <?php checked( isset( $_POST[ 'apply_for_vendor' ] ), true ) ?>
					   type="checkbox" name="apply_for_vendor" value="1"/>
                            </div>
                            <div class="righ_for">
				<label for="apply_for_vendor"
					   class="checkbox ven_1"><?php echo apply_filters('wcvendors_vendor_registration_checkbox', __( 'Apply to become a vendor? ', 'wcvendors' )); ?></label>
                            </div>
                            </p>
                        </div>
			...
			<p class="form-row sub_area">
				<input type="submit" class="button btn btn-primary s_ub" name="apply_for_vendor_submit"
